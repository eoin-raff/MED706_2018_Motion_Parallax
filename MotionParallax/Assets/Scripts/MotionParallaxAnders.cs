...
public class MotionParallaxAnders : MonoBehaviour {
	...
	{      
        float left = ( (-.5f * aspectRatio + perspectiveOffset.x) / -perspectiveOffset.z ) * cam.nearClipPlane;
        float right = ( (.5f * aspectRatio + perspectiveOffset.x) / -perspectiveOffset.z ) * cam.nearClipPlane;
        float top = ( (.5f + perspectiveOffset.y) / -perspectiveOffset.z ) * cam.nearClipPlane;
        float bottom = ( (-.5f + perspectiveOffset.y) / -perspectiveOffset.z ) * cam.nearClipPlane;
